...
package com.wxsticker.addToWts.WhatsAppBasedCode;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public static Uri AUTHORITY_URI = new Uri.Builder().scheme(StickerContentProvider.CONTENT_SCHEME).authority(BuildConfig.APPLICATION_ID + ".addToWts.WhatsAppBasedCode.StickerContentProvider").appendPath(StickerContentProvider.METADATA).build();
    ...
    public boolean onCreate() {
        final String authority = BuildConfig.APPLICATION_ID + ".addToWts.WhatsAppBasedCode.StickerContentProvider";
    ...
    public AssetFileDescriptor openAssetFile(@NonNull Uri uri, @NonNull String mode) {
        ...
        if(csp!=null){
            ...
            Log.e("TRAYIMAHE ==>>>",csp.getTrayImageUri().toString());

            ParcelFileDescriptor pfd = null;
            try {
                if(filename.equals("trayimage") && csp.getTrayImageUri()!=null){
                    pfd = getContext().getContentResolver().openFileDescriptor(
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchCode) {
            case METADATA_CODE:
                return "vnd.android.cursor.dir/vnd." + BuildConfig.APPLICATION_ID + ".addToWts.WhatsAppBasedCode.StickerContentProvider"+ "." + METADATA;
            case METADATA_CODE_FOR_SINGLE_PACK:
                return "vnd.android.cursor.item/vnd." + BuildConfig.APPLICATION_ID + ".addToWts.WhatsAppBasedCode.StickerContentProvider" + "." + METADATA;
            case STICKERS_CODE:
                return "vnd.android.cursor.dir/vnd." + BuildConfig.APPLICATION_ID + ".addToWts.WhatsAppBasedCode.StickerContentProvider" + "." + STICKERS;
