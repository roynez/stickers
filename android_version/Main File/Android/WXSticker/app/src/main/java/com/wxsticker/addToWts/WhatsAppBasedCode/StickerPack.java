...
public class StickerPack implements Parcelable {
    ...
    public StickerPack(String identifier, String name, String publisher, Uri trayImageUri, String publisherEmail, String publisherWebsite, String privacyPolicyWebsite, String licenseAgreementWebsite, Context context, String androidAppStoreLink, String iosAppStoreLinks) {
        this.identifier = identifier;
        this.name = name;
        this.publisher = publisher;
        ...
        this.licenseAgreementWebsite = licenseAgreementWebsite;
        this.stickers = new ArrayList<>();
        this.iosAppStoreLink = iosAppStoreLinks;
        this.androidPlayStoreLink = androidAppStoreLink;
    }
