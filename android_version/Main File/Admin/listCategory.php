...
<?php                                
									...
									while($row = mysqli_fetch_assoc($get_result))
									{
										...
										$category_image_src = "'".$link_category_path.$row['category_image']."'";
										...
										echo'<tr id="cate_'.$category_id.'">
												<td>
													<img onclick="zoomImage('.$category_image_src.')" class="category-image" src="'.$category_image.'"/>
												</td>
												<td>'.$category_name.'</td>
												<td>'.$is_active.'</td>
												<td>'.$created_date.'</td>
												<td>
													...
													<i class="fa fa-remove" onClick="deleteCategory('.$cate_id.');"></i>
												</td>
											</tr>';
									}	
?>                                        
