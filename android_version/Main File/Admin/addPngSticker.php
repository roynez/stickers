            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title form-title">Add PNG Sticker for iPhone App</h4>
                            </div>
                            <div class="content">
                                <form id='submit-png-sticker-form' enctype="multipart/form-data">
									<div class="row">
										<div class="col-md-2">
										</div>
										<div class="col-md-8">
...
?>													
											...
											<div class="form-group">
												<label>Select Sticker Image (Sticker image must be 512x512 & less then 100KB & .png format)</label>
												<input type="file" id="image_files" name="image_files[]" class="form-control" placeholder="Select Sticker Image" required multiple>
											</div>
