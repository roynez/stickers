...
<?php                                
									...
									while($row = mysqli_fetch_assoc($get_result))
									{
										...
										$slider_image_src = "'".$link_slider_path.$row['slider_image']."'";
										...
										echo'<tr id="slider_'.$slider_id.'">
												<td>
													<img onclick="zoomImage('.$slider_image_src.')" class="category-image" src="'.$slider_image.'"/>
												</td>
												<td>'.$slider_name.'</td>
												<td>'.$category_name.'</td>
												<td>'.$is_active.'</td>
												<td>'.$created_date.'</td>
												<td>
													<i class="fa fa-remove" onClick="deleteSlider('.$slid_id.');"></i>
												</td>
											</tr>';
									}	
?>                                        
