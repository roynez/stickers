            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title form-title">Add Webp Sticker for Android App</h4>
                            </div>
                            <div class="content">
...
?>													
											...
											<div class="form-group">
												<label> Select Sticker Image (Sticker image must be 512x512 & less then 100KB & .webp format)</label>
