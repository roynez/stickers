...
{   
	...
	public function get_active_sub_cate_by_cate_id($category_id)
	{  			
		$conn = $this->connect_db(); 		
		$sql = "SELECT * FROM tbl_sub_category WHERE category_id = '$category_id' AND is_active = 'YES' ORDER BY sub_cate_name ASC";
		$result = mysqli_query($conn,$sql);
		return $result;
	}	
	...
	public function add_sub_cate($category_id,$sub_cate_name,$sub_cate_image,$sub_cate_tray_image,$created_date)
	{  			
		$conn = $this->connect_db(); 		
		$sql = "INSERT INTO tbl_sub_category (category_id,sub_cate_name,sub_cate_image,sub_cate_tray_image,created_date) VALUE ('$category_id','$sub_cate_name','$sub_cate_image','$sub_cate_tray_image','$created_date')";
		$result = mysqli_query($conn,$sql);
		if($result)
		{
			return true;
	...
	public function update_sub_cate($sub_cate_id,$category_id,$sub_cate_name,$sub_cate_image,$sub_cate_tray_image)
	{
		$conn = $this->connect_db(); 		
		$sql = "UPDATE tbl_sub_category SET category_id='$category_id',sub_cate_name='$sub_cate_name',sub_cate_image='$sub_cate_image',sub_cate_tray_image='$sub_cate_tray_image' WHERE id = '$sub_cate_id'";
		$result = mysqli_query($conn,$sql);
		if($result)
		{
			return true;
	...
	public function get_png_sticker_count()
	{
		$conn = $this->connect_db(); 		
		$sql = "SELECT count(*) as ps_count FROM tbl_sticker_png";
		$result = mysqli_query($conn,$sql);
		return $result;
	}
	...
	{  			
		$conn = $this->connect_db(); 		
		$sql = "SELECT * FROM tbl_sticker_png WHERE sub_cate_id = '$sub_cate_id'";
		$result = mysqli_query($conn,$sql);
		return $result;
	}		
		
	public function add_png_sticker($category_id,$sub_cate_id,$sticker_image,$created_date)
	{  			
		$conn = $this->connect_db(); 		
		$sql = "INSERT INTO tbl_sticker_png (category_id,sub_cate_id,sticker_image,created_date) VALUE ('$category_id','$sub_cate_id','$sticker_image','$created_date')";
		$result = mysqli_query($conn,$sql);
		if($result)
		{
			return true;
	...
	public function update_png_sticker($category_id,$sub_cate_id,$sticker_image)
	{
		$conn = $this->connect_db(); 		
		$sql = "UPDATE tbl_sticker_png SET category_id='$category_id',sub_cate_id='$sub_cate_id',sticker_image='$sticker_image' WHERE id = '$sticker_id'";
		$result = mysqli_query($conn,$sql);
		if($result)
		{
			return true;
	...
	public function remove_png_sticker_by_id($sticker_id)
	{  			
		$conn = $this->connect_db(); 		
		$sql = "DELETE FROM tbl_sticker_png WHERE id = '$sticker_id'";
		$result = mysqli_query($conn,$sql);
		if($result)
		{
			return true;
